...
<svelte:head>
	<title>Become an Affiliate | Neuro Recursion Institute</title>
	<meta
		name="description"
		content="Join the NeuroRecursion affiliate program. Share the breakthrough and earn from those you help recover. Empathy, purpose, and sustainable income."
	/>
</svelte:head>
	...
	<Speak>
		<div class="paper container page-stack">
			<div class="section-shell teaser-shell">
				<div class="teaser-copy">
					...
					<div class="teaser-links">
						<a href="#math" class="primary-link"
							>Up to 50% commission!</a
						>
					...
					<div>
						Our affiliate program is unprecedented in the industry.
						We offer a generous 50% commission on every purchase
						your referral makes. However, you may choose to offer a
						personal discount code. If you do, it'll come out of
						your commission. For example, you can offer a 10%
						discount and still get a 40% commission. We don't
						recommend large public discounts, but if you have close
						friends and family, you do have the option to surrender
						your entire commission to give them a your 50% discount.
						The choice is yours. We just want to make it easy for
						you to share the breakthrough and get rewarded for it.
					</div>
				</div>
			...
			<div id="math" class="section-shell money-shell">
				<h2>Big Money Examples</h2>

				<p>
					If your commission is 50% of every purchase your referral
					makes. There is no upper limit. No capping. No games. This
					is a side hustle that can scale into a real business if you
					have an audience and share authentically. Here are some
					examples of what that could look like in practice:
				</p>

				<div class="revenue-examples">
					<div class="revenue-card">
						<div class="revenue-scenario">
							<h4>Conservative:<br /> 50 referrals per month</h4>
					...
					<div class="revenue-card">
						<div class="revenue-scenario">
							<h4>Moderate:<br /> 100 referrals per month</h4>
					...
					<div class="revenue-card">
						<div class="revenue-scenario">
							<h4>Ambitious:<br /> 200 referrals per month</h4>
...
<style>
	...
	.prerequisite-card p:last-child {
		margin-bottom: 0;
	}
	...
	.confidentiality-card.restricted {
		border-color: rgba(255, 152, 109, 0.24);
		background: rgba(255, 152, 109, 0.04);
	}
	...
	.confidentiality-card.restricted:hover {
		border-color: rgba(255, 152, 109, 0.4);
	}
	...
	.confidentiality-card.restricted .confidentiality-header {
		border-bottom-color: rgba(255, 152, 109, 0.24);
	}
	...
	.confidentiality-list li strong {
		color: #eaf7ff;
		display: block;
