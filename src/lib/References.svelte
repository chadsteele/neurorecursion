	...
	<div class="references">
		...
		<ul>
			...
			<li>
				...
				world-leading research in theoretical neuroscience and brain dynamics
			...
			<li>
				...
				memory reconsolidation and the neural basis of trauma and fear memory
			...
			<li>
				...
				Brain Research; advanced research in neural circuits, brain imaging,
				and neuroplasticity <a href="/pioneers/bo-li">Bo Li</a>
			</li>
			<li>
				<strong
					><a
				...
				on emotional memory, fear extinction, and reconsolidation-based therapy
			...
			<li>
				...
				landmark research on memory reconsolidation and permanent fear neutralization
